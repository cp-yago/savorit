...
export const heroDetails = {
  heading:
    "🔎 A melhor forma de encontrar e organizar suas receitas das redes sociais",
  subheading:
    "Salve, organize e aprimore receitas do Instagram com inteligência e praticidade.",
};
  ...
  return (
    ...
    >
      ...
      <div className="text-center">
        <h1 className="text-2xl md:text-2xl md:leading-tight font-bold text-foreground max-w-lg md:max-w-2xl mx-auto">
          {heroDetails.heading}
        </h1>
