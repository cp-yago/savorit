...
const RecipeCard: React.FC = () => {
  return (
    <div className="flex flex-col items-center rounded-2xl border-2 p-2">
      <img src="img/food-01.png" alt="Pastinha de alho poró" className="w-[150px]" />
      <h2 className="text-sm my-1">Pastinha de Alho Poró com Tomates Assados</h2>
      <div className="flex justify-between w-full">
        <Badge className="rounded-full bg-soft-pink">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-4 h-4">
            <path strokeLinecap="round" strokeLinejoin="round" d="M12 2.25c5.385 0 9.75 4.365 9.75 9.75s-4.365 9.75-9.75 9.75-9.75-4.365-9.75-9.75S6.615 2.25 12 2.25zM12 7.5v4.5h3" />
          </svg>
